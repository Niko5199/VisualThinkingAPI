const Parther = require("../lib/services/Parther");

describe("Tests only for Parthers", () => {
    test("Test for method readJSONVisualParthers", () => {
        expect(Parther.getAllVisualParthers()).toStrictEqual([
            {
    ...
    test("Test for method getVisualParthersEmails", () => {
        expect(Parther.getAllVisualParthersEmail("true")).toStrictEqual([
            {
                id: "6264d5d89f1df827eb84bb23",
                name: "Warren",
                email: "Todd@visualpartnership.xyz",
    ...
    test("Test for method getVisualParthersByCredits", () => {
        expect(Parther.getAllVisualParthersByCredits()).toStrictEqual([
            {
                id: "6264d5d89f1df827eb84bb23",
                name: "Warren",
                email: "Todd@visualpartnership.xyz",
